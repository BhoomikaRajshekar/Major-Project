...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_FILES['file-upload']) && isset($_POST['semester'])) {
        ...
        if (move_uploaded_file($uploadedFile['tmp_name'], $filePath)) {
            ...
            $python_path = '"C:\\Users\\Fiza Naaz\\AppData\\Local\\Programs\\Python\\Python311\\python.exe"';
            $script_path = '"C:\\wamp64\\www\\project\\templates\\process_subjects.py"';
            $command = $python_path . ' ' . $script_path . ' ' . escapeshellarg($filePath) . ' ' . escapeshellarg($semester);
